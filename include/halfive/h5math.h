...
h5point_uint H5Math_uint_pointAddPoint(
	h5point_uint a, h5point_uint b); /*Composite point addition*/
h5point_ulong H5Math_ulong_pointAddPoint(
	h5point_ulong a, h5point_ulong b); /*Composite point addition*/
h5point_umax H5Math_umax_pointAddPoint(
	h5point_umax a, h5point_umax b); /*Composite point addition*/

h5point_sint H5Math_sint_pointAddPoint(
	h5point_sint a, h5point_sint b); /*Composite signed point addition*/
h5point_slong H5Math_slong_pointAddPoint(
	h5point_slong a, h5point_slong b); /*Composite signed point addition*/
h5point_smax H5Math_smax_pointAddPoint(
	h5point_smax a, h5point_smax b); /*Composite signed point addition*/

h5point_uint H5Math_uint_pointSubPoint(
	h5point_uint a, h5point_uint b); /*Composite point substraction*/
h5point_ulong H5Math_ulong_pointSubPoint(
	h5point_ulong a, h5point_ulong b); /*Composite point substraction*/
h5point_umax H5Math_umax_pointSubPoint(
	h5point_umax a, h5point_umax b); /*Composite point substraction*/
...
h5point_uint H5Math_uint_pointMultScalar(
	h5point_uint a, h5float k); /*Multiply h5point_uint by scalar [k]*/
h5point_ulong H5Math_ulong_pointMultScalar(
	h5point_ulong a, h5float k); /*Multiply h5point_ulong by scalar [k]*/
h5point_umax H5Math_umax_pointMultScalar(
	h5point_umax a, h5float k); /*Multiply h5point_umax by scalar [k]*/

h5point_sint H5Math_sint_pointMultScalar(
	h5point_sint a, h5float k); /*Multiply h5point_sint by scalar [k]*/
h5point_slong H5Math_slong_pointMultScalar(
	h5point_slong a, h5float k); /*Multiply h5point_slong by scalar [k]*/
h5point_smax H5Math_smax_pointMultScalar(
	h5point_smax a, h5float k); /*Multiply h5point_smax by scalar [k]*/
