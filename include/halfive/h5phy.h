...
extern unsigned H5_sim(
	H5_World *stage, h5uint delta /*Time since last frame, in milliseconds*/);
extern unsigned H5_transformServer(const H5_World *stage,
	H5NET_ServerPacket *serv, enum H5NET_ModeEnum mode); /*Convert H5_World to a
											packet ready to send to clients*/
