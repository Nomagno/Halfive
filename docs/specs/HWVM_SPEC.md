...
nop (1) - TAKES NO ARGUMENTS, DOES NOTHING
...
set (5) V1 R2; SETS ADDRESS R2 *TO* VALUE V1
...
rot (11) R1 V2 - IF V2 IS 0 THROUGH 7, BITSHIFT R1 LEFT BY V2, WRITE THE RESULT TO R1.
