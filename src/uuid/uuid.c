...
char *uuid(int seed)
{
	...
	sprintf(formatted, "%.8s-%.4s-%.4s-%.4s-%.12s", uuid, &(uuid[8]),
		&(uuid[12]), &(uuid[16]), &(uuid[20]));
	return (formatted);
